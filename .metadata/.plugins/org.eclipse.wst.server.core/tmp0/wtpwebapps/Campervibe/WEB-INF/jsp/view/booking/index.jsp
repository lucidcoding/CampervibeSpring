...
<h1>Bookings</h1>
<img src="<c:url value="/resource/images/CoolCats.gif" />"
	alt="Cool Cats" />
<p>
...
<table>
	...
	<c:forEach items="${viewModel.bookings}" var="booking">
		<tr>
			...
			<td><fmt:formatDate value="${booking.startDate}" type="date"
					dateStyle="long" /></td>
			<td><fmt:formatDate value="${booking.endDate}" type="date"
					dateStyle="long" /></td>
			<td>${booking.vehicleName}</td>
			<td><a
				href="<c:url value="/booking/view">
