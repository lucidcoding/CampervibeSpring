...
public class GetConflictingBookingsTests {
	...
	/**
	 * Test the case when start date and end date are before the earlier
	...
	public void nothingReturnedIfBeforeEarliestBooking() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("26-10-2015 00:00:00"),
	...
	public void returnsBookingIfStartDateBeforeAndEndDateEqualsStart() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("31-10-2015 00:00:00"),
	...
	public void returnsBookingIfStartDateIsEqualAndEndIsAfterStart() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("02-11-2015 00:00:00"),
				dateFormat.parse("03-11-2015 00:00:00"));
	...
	public void returnsBookingIfStartAfterStartAndEndEqualsEnd() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("03-11-2015 00:00:00"),
				dateFormat.parse("06-11-2015 00:00:00"));
	...
	public void returnsBookingIfStartEqualsEndAndEndAfterEnd() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("06-11-2015 00:00:00"),
	...
	public void returnsNothingIfStartAfterEndAndEndAfterEnd() throws ParseException {
		// Act.
		List<Booking> result = vehicle.getConflictingBookings(dateFormat.parse("08-11-2015 00:00:00"),
